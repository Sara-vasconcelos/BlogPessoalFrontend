...
//useParams é o parametro que ele espera receber
//id:string : é pq esse id vai vim em uma url do site , e a url é uma string 
  ...
  async function buscarPorId(id: string) {
    try {//está com crazes porque é uma variavel que está dentro de uma string , não funciona com aspas
